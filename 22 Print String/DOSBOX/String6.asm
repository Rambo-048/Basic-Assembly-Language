...
String4 DB 'NEVER GIVE UP',13,10,'$'
...
Process:
	...
	LEA DX,String0+8	;Take Address OFFSET +8
	...
	INT 21h			;Print Behind $ Signed
	LEA DX,String4		;Take Address Offset from String2
	INT 21h			;Print character --> signed $
	LEA DX,String3+10	;Take Address Offset from String3
	INT 21h			;Print character --> signed $
	INT 20h			;exit
